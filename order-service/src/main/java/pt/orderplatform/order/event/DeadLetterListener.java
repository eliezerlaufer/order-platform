...
// =============================================================================
// DEAD LETTER LISTENER — regista mensagens que esgotaram todas as tentativas
// =============================================================================
// Consome os tópicos .DLT correspondentes às subscrições deste serviço.
// Não tenta reprocessar — apenas faz log ERROR para monitorização.
//
// Em produção: ligar a um sistema de alertas (PagerDuty, Slack, etc.)
// Visível também no Kafka UI (http://localhost:8090) para análise manual.
// =============================================================================
@Slf4j
@Component
public class DeadLetterListener {
    ...
    @KafkaListener(
            topics = {
                    ...
                    "inventory.reservation.failed.DLT",
                    "payments.payment.processed.DLT",
                    "payments.payment.failed.DLT"
            },
