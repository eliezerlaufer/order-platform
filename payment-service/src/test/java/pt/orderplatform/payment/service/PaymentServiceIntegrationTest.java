...
import pt.orderplatform.payment.BaseIntegrationTest;
...
//
// SEM @Nested: cada classe @Nested cria um Spring context separado, o que gera
// múltiplos KafkaConsumers no mesmo consumer group. A distribuição de partições
// Kafka entre consumers é não-determinística → flakiness. Todos os testes
// partilham um único context e um único consumer Kafka.
//
// O StripeGateway é mockado via @MockitoBean. Cada teste configura o stub
// necessário no início do método (true → PROCESSED, false → FAILED).
// =============================================================================
